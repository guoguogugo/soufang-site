...
(function ($, undefined) {
    ...
    $.widget("ui.resizable", $.ui.mouse, {
        ...
        _respectSize: function (data, event) {
            ...
            var el = this.helper, o = this._vBoundaries, pRatio = this._aspectRatio || event.shiftKey,
                a = this.axis,
 ...
 */
    ...
    $.ui.plugin.add("resizable", "alsoResize", {
        ...
        resize: function (event, ui) {
            var that = $(this).data("resizable"), o = that.options, os = that.originalSize,
    ...
    $.ui.plugin.add("resizable", "containment", {
        ...
        resize: function (event, ui) {
            var that = $(this).data("resizable"), o = that.options,
                ...
                pRatio = that._aspectRatio || event.shiftKey, cop = {top: 0, left: 0},
